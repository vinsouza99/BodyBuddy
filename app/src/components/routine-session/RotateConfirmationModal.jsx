...
import RotateConfirm from "../../assets/rotate_confirm.png";
    ...
    >
      <Box sx={modalStyle}>
        ...
        <Typography textAlign="center">
          Some information will not be displayed as there is mobile screen size limit. We recommend using your desktop browser to have the best experience.
        </Typography>
        <Box
          sx={{
            display: 'flex',
